...
public class MusicService extends Service {
    ...
    static final String[] musics = { "door.mp3","fish.mp3", "three.mp3", "ZOOM.mp3" };
    MediaPlayer mPlayer;
    ...
    public void onCreate() {
        ...
        filter.addAction(music.CTL_ACTION);
        ...
        mPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                //发送广播通知Activity更改文本框
                Intent sendIntent = new Intent(music.UPDATE_ACTION);
            ...
            while (true)
            {
                ...
                if (status == 0x12)
                {
                    try {
                        ...
                        Thread.sleep(1000);
                        // 给主线程发送广播
                        Intent sendIntent1 = new Intent(music.UPDATE_ACTION);
                        // 当前进度
