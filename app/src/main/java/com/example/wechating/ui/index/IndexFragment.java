...
public class IndexFragment extends Fragment {
    ...
    public void initData(){
        ...
        mDatas.add(new Friends("丁丁鱼"));
        mDatas.add(new Friends("弯弯越"));
        mDatas.add(new Friends("勤勤恳恳老实彬"));
        mDatas.add(new Friends("邱聪明"));
        mDatas.add(new Friends("大笨婷"));
        mDatas.add(new Friends("如花聪"));
        mDatas.add(new Friends("博博狗"));
