...
public class FriendsFragment extends Fragment {
    ...
    private void initData() {
        list=new ArrayList<>();
        list.add(new Friends("邱邱邱"));//1
        list.add(new Friends("垃圾嘉"));//2
        list.add(new Friends("大笨婷"));//3
        list.add(new Friends("丁丁鱼"));//4
        list.add(new Friends("如花聪"));//5
        list.add(new Friends("头头贝"));//6
        list.add(new Friends("勤勤恳恳老实彬"));//7
        list.add(new Friends("弯弯越"));//8
        list.add(new Friends("博博狗"));//9
        list.add(new Friends("木木獒"));//10
        list.add(new Friends("哥哥扬"));//11
        list.add(new Friends("邱聪明"));//12
        list.add(new Friends("美羊羊"));//13
        list.add(new Friends("蔡坤坤"));//14
        list.add(new Friends("废羊羊"));//15
