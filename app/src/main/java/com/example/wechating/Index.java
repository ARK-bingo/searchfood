...
import com.example.wechating.sensor;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_music:
                Intent intents = new Intent(Index.this, music.class);
                startActivity(intents);
                return true;
            case R.id.menu_addFriend:
                Intent intent = new Intent(Index.this, AddFriendPage.class);
                Log.d("shabi", "onCreate:haha1 ");
                startActivity(intent);
                return true;
            case R.id.menu_yaoyiyao:
                intent = new Intent(Index.this, sensor.class);
                Log.d("shabi", "onCreate:haha2 ");
                startActivity(intent);
